      implicit none
      integer nmax,nnmax
      parameter(nmax=1400000,nnmax=170)
      ...
      common/relaxp/ trelax,bimpact,vinf2,equalmass,treloff
      common/relaxp2/tresplintmuoff,omega2,omega_spin,nrelax,nitpot
      common/relaxp3/stellarevolutioncodetype
      ...
      common/part/ x,y,z,vx,vy,vz,am,hp,u,rho,por2,grpot,zeta
      common/part2/bonet_omega,bonet_0mega, bonet_psi, bonet_wn,max_vsig
      common/dyn/ vxdot,vydot,vzdot,udot,gx,gy,gz,tthermal,ueq,popacity
      integer kdm
...
!     For ncooling=2 and ncooling=3
      real*8 uraddot(nmax),temperatures(nmax),tau(nmax),rout(nmax)
      real*8 dEemergdt(nmax),dEdiffdt(nmax),dEmaxdiffdt(nmax)
      real*8 uraddotcool(nmax),uraddotheat(nmax),myuraddotheat(nmax)
      common/coolingarrs/uraddot,temperatures,tau,dEemergdt,dEdiffdt
      common/coolingarrs2/dEmaxdiffdt,rout,uraddotcool,uraddotheat
      common/coolingarrs3/myuraddotheat
