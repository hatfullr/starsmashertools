...
class Archive(dict, object):
    ...
    def _dataname(self):
        ...
        # looks like a file name. It should end with ".json"
        with starsmashertools.helpers.file.open(
            ...
            for name in all_names:
                ...
                return name
        raise Exception("Failed to find an appropriate name in the zipped archive for which the data is stored. Expected to find a name which ends with '.json' but received names: %s" % str(all_names))
